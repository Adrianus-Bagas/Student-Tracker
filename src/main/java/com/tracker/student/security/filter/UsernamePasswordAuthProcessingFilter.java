package com.tracker.student.security.filter;
...
public class UsernamePasswordAuthProcessingFilter extends AbstractAuthenticationProcessingFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		if (StringUtils.isBlank(dto.nomorInduk()) || StringUtils.isBlank(dto.password())) {
			throw new BadRequestException("nomor induk and password should be provided");
		}
		UsernamePasswordAuthenticationToken token = new UsernamePasswordAuthenticationToken(dto.nomorInduk(),
				dto.password());
